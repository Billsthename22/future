...
export default function BrandModels() {
  // ✅ Correctly type the params object
  const params = useParams() as { brand?: string };

  // ✅ Safely extract brand parameter
  ...
  // Normalize for comparison (remove spaces and hyphens)
  const normalize = (str: string) => str.toLowerCase().replace(/[-\s]/g, '');

  // Find matching brand key from JSON
  const brandKey =
